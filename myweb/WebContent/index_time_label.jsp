...
<script>
	...
	//	var label = url.split("=");
		console.log("get->" + timeData);
		//$("#title").html(label[1]);
		$("#label").html(timeData);//设置页面标签的名字
		var labelData = new Object();
		labelData.time = timeData;
		$.ajax({
			method : "post",
			url : "GetTimeTextServlet",
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-6" id="text">
			     <div class="row"><h2 id = "label"></h2></div>
				<div class="row">
